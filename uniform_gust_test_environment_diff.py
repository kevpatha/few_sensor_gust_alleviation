...
class mfc_gust_Env(gym.Env):
    ...
    def __init__(self, start_volt = 2.5, deflect = 200, steps_per_ep = 200, seed = 0):
        ...
        #self.press_taps.ai_channels.add_ai_voltage_chan("Dev2/ai6", terminal_config = TerminalConfiguration.RSE)
        num_taps = 6
        ...
        #print('goal set: ', self.goal_press)
